...
const Skills = ({skillsRef}) => {
    ...
    return (
        <div className="Skills" id='skills' ref={skillsRef}>
            <h1>Навыки</h1>
            <p>Я-разработчик, работающий на разных языках программирования, имею опыт в работах с различными технологиями.Всегда ставлю перед собой новые цели и задачи, и как правило, достигаю их.</p>
